      ...
      <main className="home-page">
        <section className="home-page__intro">
          ...
          <p className="home-page__intro-sub">
            AnkHeal is your personalized rehab companion, built to help you
            heal, and strengthen your ankle with exercises that work for you.
          </p>
        </section>
        ...
        <section className="home-page__cta">
          <h4 className="home-page__explanation">
            Don't let stiffness sneak up on you. Your mobility depends on
            strong, flexible ankles.
          </h4>
          <Link
            to="/questionnaire"
